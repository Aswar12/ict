			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Jl. AS. DG. Kalebbu, SMA Negeri 2 Pangkep, Lab Komputer.</li>
						<li><i class="icon-phone"></i>+62 852-5407-3967</li>
						<li><i class="icon-envelope"></i><a href="#">ict@sman1segeri.sch.id</a></li>
						<li><i class="icon-globe"></i><a href="#">ict.sman2pangkep.sch.id</a></li>
					</ul>
				</div>
				...
				<?php echo $this->session->flashdata('msg');?>
					...
					<form method="post" action="<?php echo base_url().'kontak/kirim_pesan'?>">
						...
						<div class="col-md-12">
							<div class="form-group">
								<input value="Kirim Pesan" class="btn btn-danger" type="submit">
							</div>
						</div>
					</form>
					</div>
