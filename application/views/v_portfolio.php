...
<html class="no-js">
			...
			<h1><a href="<?php echo base_url().''?>"><span>ICT</span> SMADAP</a></h1>
				<nav role="navigation">
					<ul>
						...
						<li class="active"><a href="<?php echo base_url().'portfolio'?>">Karya</a></li>
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/b-karya.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Kreatif dan Inovatif</h2>
		   					<p class="fh5co-lead">Tidak ada batasan sebagai anak mudah untuk kita berkarya di dunia IT</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
