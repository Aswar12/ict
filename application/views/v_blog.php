...
<html class="no-js">
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/b-blog.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>ICT Blog</h2>
		   					<p class="fh5co-lead">Tulisan terupdate tentang ICT, SMAN Negeri 2 Pangkep, dan Teknologi terbaru di dunia IT</p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
			...
			<div class="row">
				...
				?>
					<div class="col-md-4">
						...
						<p><a href="<?php echo base_url().'artikel/'.$post_slug;?>" class="btn btn-danger with-arrow">Selengkapnya <i class="icon-arrow-right"></i></a></p>
					</div>
					<?php endforeach;?>
