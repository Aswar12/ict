...
<html class="no-js"> <!--<![endif]-->
	...
	<div class="fh5co-about animate-box">
		...
		<div class="container">
			...
			<div class="col-md-6">
				<h3>Visi</h3>
				<ul>
					<li>Merancang lingkungan sekolah yang tebuka akan dunia teknologi, berkreasi dan berinovasi dalam pengembangan karakter ICT sebagai pusat pembelajaran teknologi.</li>
				</ul>
				<h3>Misi</h3>
				<ul>
	...
	<div class="fh5co-team animate-box" style="background-color: #b3b3b3;">
		<div class="container" >
